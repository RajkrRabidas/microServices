...
describe('User addresses API', () => {
    ...
    describe('POST /api/auth/users/me/addresses', () => {
        it('validates pincodecode and phone and returns 400 on invalid input', async () => {
        ...
        it('adds an address and can set it as default', async () => {
            ...
            // default marking can be communicated either b y isDefault flag or separate default id
